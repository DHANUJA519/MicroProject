...
export class AppComponent {  
 ...
 insertEmployee(data : any) {
  ...
  this.employee.empPerformance = data.empPerformance;
 ...
 findEmployee(data:any){
  ...
  this.result=this.employee.id+" "+this.employee.empName+" "+this.employee.empPerformance;
 }
 findEmployeeAll(data:any){
